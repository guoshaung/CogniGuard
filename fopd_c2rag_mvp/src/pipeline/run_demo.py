...
from src.c2rag.c2rag_metrics import compute_c2rag_metrics
from src.c2rag.exposure_budget import ExposureBudget
from src.c2rag.retriever import CopyrightAwareRetriever
from src.c2rag.return_policy import produce_controlled_resource
from src.common.metrics import summarize_metric_rows
from src.common.schemas import StudentProfile, TeacherResource
from src.common.text_utils import read_jsonl, write_json, write_jsonl
from src.common.trace_binding import (
...
from src.pipeline.ag2_simulator import build_ag2_request, compose_final_answer
