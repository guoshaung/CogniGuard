        ...
        cases.append(
            {
                ...
                "source_type": snippet.get("source_type", "teacher_resource_repository"),
                "license_type": snippet.get("license_type", "course_limited_license"),
                "source_trace_id": snippet.get("source_trace_id"),
                "trace_scope": (snippet.get("source_trace") or {}).get("trace_scope", "resource_level_provenance"),
                "trace_owner": (snippet.get("source_trace") or {}).get("trace_owner", "C2-RAG"),
                "watermark_boundary": (snippet.get("source_trace") or {}).get(
                    "watermark_boundary",
                    "generation_watermarking_is_owned_by_HSW-ST",
                ),
                "policy_reason": snippet.get("policy_reason"),
                ...
                "retrieval_trace": snippet.get("retrieval_trace", []),
...
def _fallback_c2rag_case() -> dict[str, Any]:
    return {
        ...
        "source_type": "teacher_resource_repository",
        "license_type": "course_limited_license",
        "source_trace_id": "trace_fallback_resource",
        "trace_scope": "resource_level_provenance",
        "trace_owner": "C2-RAG",
        "watermark_boundary": "generation_watermarking_is_owned_by_HSW-ST",
        "policy_reason": "controlled_summary_or_snippet_with_resource_trace",
        "quote_span_hash": None,
        "controlled_output_hash": "fallback_controlled_output_hash",
        "resource_provenance_commitment": "fallback_resource_provenance_commitment",
        "retrieval_trace": [
            {
                "rank": 1,
                "resource_id": "resource_fallback",
...
def _fallback_demo_result() -> dict[str, Any]:
    return {
        ...
        "compliance_state": {
            ...
            "data_retention_policy_id": "course_limited_hash_audit_v1",
        },
        "compliance_policy": {
            "decision": "allow",
            "reason": "Fallback minimized context card is allowed.",
            "blocked_fields": [],
            "allowed_fields": ["knowledge_point", "current_error_type"],
