...
#   powershell -ExecutionPolicy Bypass -File "D:\pycharm\CogniGuard\hsw_st_minimal\scripts\install_pytorch_cuda.ps1"
#
# 注意:
# - .venv 在仓库根 CogniGuard\.venv，不在 hsw_st_minimal\.venv；不要 cd 到子目录后执行 .\.venv\...
