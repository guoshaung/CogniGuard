...
from protection.fopd_c2rag_mvp.src.common.schemas import ProfileRecord, StudentProfile, Task
from protection.fopd_c2rag_mvp.src.common.text_utils import SimpleTfidfVectorizer, clamp01, cosine_sparse
