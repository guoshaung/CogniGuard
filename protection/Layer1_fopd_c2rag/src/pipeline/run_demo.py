...
from protection.fopd_c2rag_mvp.src.agents.multi_agent_orchestrator import MultiAgentOrchestrator
from protection.fopd_c2rag_mvp.src.c2rag.c2rag_metrics import compute_c2rag_metrics
from protection.fopd_c2rag_mvp.src.c2rag.exposure_budget import ExposureBudget
from protection.fopd_c2rag_mvp.src.c2rag.retriever import CopyrightAwareRetriever
from protection.fopd_c2rag_mvp.src.c2rag.return_policy import produce_controlled_resource
from protection.fopd_c2rag_mvp.src.common.metrics import summarize_metric_rows
from protection.fopd_c2rag_mvp.src.common.schemas import StudentProfile, TeacherResource
from protection.fopd_c2rag_mvp.src.common.text_utils import read_jsonl, write_json, write_jsonl
from protection.fopd_c2rag_mvp.src.common.trace_binding import (
...
from protection.fopd_c2rag_mvp.src.fopd.context_card import build_context_card
from protection.fopd_c2rag_mvp.src.fopd.fopd_metrics import compute_fopd_metrics
from protection.fopd_c2rag_mvp.src.fopd.profile_selector import ProfileSelector
from protection.fopd_c2rag_mvp.src.fopd.task_parser import parse_task
...
def main() -> None:
    ...
    ap.add_argument("--profiles", default="data/profiles.jsonl")
    ap.add_argument("--questions", default="data/student_questions.jsonl")
    ap.add_argument("--resources", default="data/teacher_resources.jsonl")
    ap.add_argument("--config", default="configs/default.yaml")
    ap.add_argument("--out", default="outputs/demo_results.jsonl")
    args = ap.parse_args()
