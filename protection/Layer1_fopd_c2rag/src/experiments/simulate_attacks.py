...
from protection.fopd_c2rag_mvp.src.common.text_utils import cosine_text, lcs_ratio, read_jsonl, write_json
from protection.fopd_c2rag_mvp.src.pipeline.run_demo import load_config, load_resources
...
def simulate(config_path: str | Path) -> dict[str, Any]:
    ...
    resources = load_resources(root / "data/teacher_resources.jsonl")
    attacks = read_jsonl(root / "data/attacks.jsonl")
    ...
    out_csv = root / "outputs/attack_simulation.csv"
    ...
    write_json(root / "outputs/attack_simulation_summary.json", summary)
    return summary
